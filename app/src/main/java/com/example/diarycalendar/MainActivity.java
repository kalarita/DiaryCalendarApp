...
import com.example.diarycalendar.diytocal.AddDiaryActivity;
import com.example.diarycalendar.diytocal.AddEventActivity;
import com.example.diarycalendar.diytocal.DiaryMainActivity;
import com.example.diarycalendar.diytocal.EventMainActivity;
import com.example.diarycalendar.ui.adapter.fragmentadapter;
import com.example.diarycalendar.ui.fragment.home_fragment;
import com.example.diarycalendar.ui.fragment.todayinhis_fragment;
import com.example.diarycalendar.ui.fragment.todayinmyhis_fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mIntent = new Intent(MainActivity.this, AddDiaryActivity.class);
//                mIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        button_b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mIntent = new Intent(MainActivity.this, AddEventActivity.class);
//                mIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(mIntent);
        ...
        //viewpager切换
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) findViewById(R.id.appBarLayout);
        ViewPager viewPager = coordinatorLayout.findViewById(R.id.view_pager_main);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.nav_diary: // 点击 日记 的行为
                mIntent = new Intent(MainActivity.this, DiaryMainActivity.class);
//                mIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(mIntent);
                break;
            case R.id.nav_schedule: // 点击 日日程 的行为
                mIntent = new Intent(MainActivity.this, EventMainActivity.class);
//                mIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(mIntent);
                break;
            case R.id.exit: // 点击 关于 的行为
                SharedPreferences tpsf = getSharedPreferences("login",MODE_PRIVATE);
                SharedPreferences.Editor tpeditor = tpsf.edit();
//        tpeditor.putString("history_account", tpsf.getString("account", "未登陆"));
                tpeditor.remove("loginstatus");
                tpeditor.apply();
                Intent intent = new Intent();
                intent.setClass(MainActivity.this, login_activity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);;
                startActivity(intent);
                break;

...
import com.example.diarycalendar.ui.WebDav.WebDavSardineUtil;
import com.example.diarycalendar.ui.WebDav.WebDavUtil;
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        // 根据配置文件配置初始化ui
        config = getSharedPreferences(getResources().getString(R.string.app_config),MODE_PRIVATE);
        editor = config.edit();
        ...
        if(!config.contains(getResources().getString(R.string.auto_update))){
            editor.putString(getResources().getString(R.string.auto_update), "false");
        }
...
//        tpeditor.putString("history_account", tpsf.getString("account", "未登陆"));
        ...
        intent.setClass(SettingActivity.this, login_activity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);;

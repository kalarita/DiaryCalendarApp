    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mBackSure =  new AlertDialog.Builder(AddEventActivity.this)
                        .setTitle("确定返回")
        ...
        mSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //存到本地
                BackupUtil.rewrite(mDb, "Event", mDate.getText().toString(), AddEventActivity.this);
                //上传到webdav

                Intent intent = new Intent(AddEventActivity.this, EventMainActivity.class);
